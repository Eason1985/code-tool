 ...
 *
 */
@EntityPK(Pk = "idgenerator_id", tableName = "TB_SYSR_IDGENERATOR")
public class MetadbIdgeneratorDto {//
	//
	@EntityColumn(dataType=12, typeName="VARCHAR", remarks = "主键"  )
	private java.lang.String idgenerator_id;//
   ...
   public java.lang.String getIdgenerator_id() {
	return idgenerator_id;
}

public void setIdgenerator_id(java.lang.String idgenerator_id) {
	this.idgenerator_id = idgenerator_id;
}
