		...
		<div class="content-body">
			...
			<div class="result-content">
				<table  id="dg_tbTraceInfo" class="easyui-datagrid" title="DataGrid Title" style="width:auto;height:300px"
					data-options="rownumbers:false,singleSelect:true,collapsible:true,sortName:'',sortOrder:'desc',pagination:'true',url:'<%=path%>/search_tbTraceInfo_getListData.do',method:'post'">
					<thead>
						<tr>
    ...
    tbTraceInfo_list.buildJsonEditParams = function(){
		  	var editContent =	{
		  		//页面输入框部分
					...
					trace_describe :document.getElementById("edit_trace_describe").value(), 
