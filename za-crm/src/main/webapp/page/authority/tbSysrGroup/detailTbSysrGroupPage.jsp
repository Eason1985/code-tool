				...
				<div class="search-panel-bd">
					<table class="search-table">
					   	 <tr>
								...
								<td>
									<input type="text" id="detail_group_name" name="detail_group_name"   style="width:200px;border-width: 0" readonly="true" />
								</td>
...
$(document).ready(function(){ 
	...
	acjAjax({
		type:'POST',
		url:'<%=path%>'+"/detail_TbSysrGroup.do?pkid="+'<%=pkid%>',    
		success:function(data){
		 	data = $.parseJSON(data);
		 	var message = data.message;
				$("#detail_group_id").val(message.group_id); 
				$("#detail_group_name").val(message.group_name); 
