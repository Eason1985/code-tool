...
public class CharacterConversionUtil {
	...
	public static String change(String value ) throws UnsupportedEncodingException{
		if(value == null ){
			return null ; 
		}
...
class ServerUtil {  
    ...
    public static boolean isJetty() {  
        if (_instance._jetty == null) {  
            Class c = _instance.getClass();  
            if (c.getResource(JETTY_CLASS) != null) {  
            	_instance._jetty = Boolean.TRUE;  
            } else {  
            	_instance._jetty = Boolean.FALSE;  
            }  
        }  
        return _instance._jetty.booleanValue();  
    }  
