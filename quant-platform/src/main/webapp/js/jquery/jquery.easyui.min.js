 ...
 *
 *
 *下拉框(加滚动条   搜索关键字$.fn.combo.defaults)
 *
 */
(function($){
...
$.ajax({url:opts.href,type:opts.method,data:opts.params,cache:false,dataType:"html",success:function(data){
_1f3(opts.extractor.call(_1f0,data));
$.fn.panel.global.onLoad.apply(_1f0,arguments);
...
_200.hide();
opts.closed=true;
$.fn.panel.global.onClose.call(_1fe);
...
$.fn.panel.defaults={id:null,title:null,iconCls:null,width:"auto",height:"auto",left:null,top:null,cls:null,headerCls:null,bodyCls:null,style:{},href:null,cache:true,fit:false,border:true,doSize:true,noheader:false,content:null,collapsible:false,minimizable:false,maximizable:false,closable:false,collapsed:false,minimized:false,maximized:false,closed:false,tools:null,href:null,loadingMessage:"Loading...",method:"get",params:null, extractor:function(data){
var _229=/<body[^>]*>((.|[\n\r])*)<\/body>/im;
...
$.fn.panel.global.onClose = function(){};
})(jQuery);
(function($){
...
(function(k){
	var btn=opts.toolbar[k];
	if(btn=="-"){
	$("<td><div class=\"dialog-tool-separator\"></div></td>").appendTo(tr);
	}else{
	var td=$("<td></td>").appendTo(tr);
	var tool=$("<a href=\"javascript:void(0)\"></a>").appendTo(td);
	tool[0].onclick = eval((btn.handler && function(){btn.handler.apply(_256, arguments);}) || function(){});
...
(function(k){
	var p=opts.buttons[k];
	var _25a=$("<a href=\"javascript:void(0)\"></a>").appendTo(_259);
	if(p.handler){
	_25a[0].onclick=function(){p.handler.apply(_256, arguments);}
	}
	_25a.linkbutton(p);
})(i);
}
...
opts.href=null;
opts.content=null;
_257.panel({closed:opts.closed,cache:opts.cache,method:opts.method,params:opts.params,href:_25b,content:_25c,extractor:opts.extractor,onLoad:function(){
if(opts.height=="auto"){
$(_256).window("resize");
}
...
var _278="<span class='messager-text'>"+msg+"</span>";
_278 = (icon ? "<i class='messager-icon messager-"+icon+"'></i>" : "") +_278;
_278 = "<div class='messager-text-wrap'>"+_278+"</div>";
var _279={};
...
var _422=opts.invalidMessage||rule["message"];
if(_421){
...
$.fn.validatebox.defaults={required:false,validType:null,delay:200,missingMessage:"\u6b64\u9879\u4e0d\u80fd\u4e3a\u7a7a",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
...
select:{
	validator: function(_42f){
		return $.trim(_42f) != '\u8bf7\u9009\u62e9';
	},
	message: 'Please fix this field'
}
...
_68e.push('<div class="datagrid-nodata">'+opts.noDataMsg+'</div>');
}else{
_68e.push("<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>");
for(var i=0;i<rows.length;i++){
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,noDataMsg:"No data to display",loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_6c3,_6c4){
...
_7f7.panel("resize",{width:(opts.panelWidth?opts.panelWidth:_7f6.outerWidth()),height:opts.panelHeight||"auto"});
